...
export class CblReactNativeEngine implements ICoreEngine {
  ...
  constructor(customEventEmitter?: NativeEventEmitter) {
    ...
    if (customEventEmitter) {
      ...
      // New arch: all events flow through the global JSI event bus — no module arg needed
  ...
  database_Close(args: DatabaseArgs): Promise<void> {
    ...
    return new Promise((resolve, reject) => {
      NativeCblDatabase.database_Close(args.name).then(
        () => {
  ...
  database_Delete(args: DatabaseArgs): Promise<void> {
    ...
    return new Promise((resolve, reject) => {
      NativeCblDatabase.database_Delete(args.name).then(
        () => {
  ...
  database_GetPath(args: DatabaseArgs): Promise<{ path: string }> {
    return new Promise((resolve, reject) => {
      NativeCblDatabase.database_GetPath(args.name).then(
  ...
  database_PerformMaintenance(
    ...
    return new Promise((resolve, reject) => {
      NativeCblDatabase.database_PerformMaintenance(numValue, args.name).then(
        () => resolve(),
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        (error: any) => {
          reject(error);
  ...
  collection_CreateCollection(args: CollectionArgs): Promise<Collection> {
    return new Promise((resolve, reject) => {
      NativeCblCollection.collection_CreateCollection(
        ...
        (result) => {
          resolve(result as unknown as Collection);
        },
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        (error: any) => {
          reject(error);
  ...
  collection_GetDefault(args: DatabaseArgs): Promise<Collection> {
    return new Promise((resolve, reject) => {
      NativeCblCollection.collection_GetDefault(args.name).then(
        (result) => {
          resolve(result as unknown as Collection);
        },
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
  ...
  collection_RemoveChangeListener(
    ...
    return new Promise((resolve, reject) => {
      ...
      NativeCblCollection.collection_RemoveChangeListener(token).then(
        () => {
          this.debugLog(
  ...
  collection_GetDocumentExpiration(
    ...
    return new Promise((resolve, reject) => {
      NativeCblDocument.collection_GetDocumentExpiration(
        ...
        (der) => {
          resolve(der as unknown as DocumentExpirationResult);
        },
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        (error: any) => {
          reject(error);
  ...
  query_Execute(args: QueryExecuteArgs): Promise<Result> {
    return new Promise((resolve, reject) => {
      NativeCblQuery.query_Execute(args.query, args.parameters, args.name).then(
        (result) => {
  ...
  query_Explain(args: QueryExecuteArgs): Promise<{ data: string }> {
    return new Promise((resolve, reject) => {
      NativeCblQuery.query_Explain(args.query, args.parameters, args.name).then(
        (result) => {
  ...
  query_RemoveChangeListener(
    ...
    return new Promise((resolve, reject) => {
      ...
      NativeCblQuery.query_RemoveChangeListener(token).then(
        () => {
          this.debugLog(
  ...
  scope_GetDefault(args: DatabaseArgs): Promise<Scope> {
    return new Promise((resolve, reject) => {
      NativeCblScope.scope_GetDefault(args.name).then(
        (result) => {
          resolve(result as unknown as Scope);
        },
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        (error: any) => {
          reject(error);
  ...
  scope_GetScope(args: ScopeArgs): Promise<Scope> {
    return new Promise((resolve, reject) => {
      NativeCblScope.scope_GetScope(args.scopeName, args.name).then(
        (result) => {
          resolve(result as unknown as Scope);
        },
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
  ...
  scope_GetScopes(args: DatabaseArgs): Promise<ScopesResult> {
    return new Promise((resolve, reject) => {
      NativeCblScope.scope_GetScopes(args.name).then(
        (result) => {
  ...
  async logsinks_SetFile(args: LogSinksSetFileArgs): Promise<void> {
    return NativeCblLogging.logsinks_SetFile(args.level, args.config);
  }
  ...
  async logsinks_SetCustom(args: LogSinksSetCustomArgs): Promise<void> {
    return NativeCblLogging.logsinks_SetCustom(
      args.level,
      args.domains,
      args.token
    );
